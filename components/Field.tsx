          ...
          <div className="w-full max-w-sm bg-white p-6 rounded-xl shadow-lg text-center">
            ...
            {workerCode && (
              <div className="border-2 border-indigo-300 rounded-xl p-4 bg-indigo-50">
                ...
                <p className="text-left"><span className="font-semibold">ID:</span> {workerCode}</p>
                <p className="text-left"><span className="font-semibold">Name:</span> {form.full_name}</p>
                <p className="text-left"><span className="font-semibold">Category:</span> {selectedSkills.join(", ")}</p>
                <p className="text-left"><span className="font-semibold">Address:</span> {form.address}</p>

                <div className="mt-4">
                  <Barcode value={workerCode} width={2} height={50} />
                </div>
              </div>
            )}
