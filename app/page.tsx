    ...
    <>
      ...
      <section className="container py-12">
        ...
        <div className="mb-16">
          ...
          >
            {[
              { src: "/posters/poster4.jpg", alt: "Hire Trusted Workers", caption: "Hire Verified Workers Easily" },
              ...
              <SwiperSlide key={i}>
                <div className="relative h-[32rem] flex items-center justify-center bg-gradient-to-tr from-gray-300 via-gray-00 to-gray-700">

                  {/* Poster Image (fits, never crops) */}
                  <img
                    src={slide.src}
                    alt={slide.alt}
                    className="max-h-[28rem] w-auto object-contain drop-shadow-2xl transition-transform duration-700 group-hover:scale-105"
                  />

                  {/* Gradient Caption Overlay */}
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/60 to-transparent p-8">
                    <h3 className="text-2xl md:text-3xl font-bold text-green-600 tracking-wide drop-shadow-lg">
                      {slide.caption}
                    </h3>
                    <p className="text-gray-300 text-sm md:text-base mt-2 max-w-xl">
                      Workkerz.com makes hiring trusted professionals simple, fast, and secure.
                    </p>
                  </div>
                </div>
              </SwiperSlide>
