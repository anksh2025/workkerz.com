...
export default function Home() {
 ...
 useEffect(() => {
  const fetchRatings = async () => {
    try {
      const res = await fetch("/api/ratings"); // ✅ must match route.ts
      ...
      setRatingData({
        ...
        count: data.count,
        breakdown: data.breakdown || [0, 0, 0, 0, 0], // fallback
      });
    } catch (err) {
      ...
      setRatingData({
        average: 0,
        count: 0,
        breakdown: [0, 0, 0, 0, 0], // safe fallback
      });
    }
  };
    ...
    <>
      ...
      <footer className="bg-gray-800 text-gray-300 py-10">
        <div className="container">
          ...
          {/* Links Section */}
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 mt-5 text-center md:text-left">
            {/* For Customers */}
            <div>
          ...
          {/* Divider */}
          <div className="mt-2 border-t border-gray-700 pt-5 text-center text-sm md:text-base">
