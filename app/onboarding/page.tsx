...
import { Images, SwitchCamera, Check, ChevronDown } from "lucide-react";
...
export default function OnboardingPage() {
  ...
  onChange={(val: { value: string; label: string }) => setForm({ ...form, durationType: val.value })}
>
  <div className="relative">
      ...
      {DURATION_OPTIONS.map((opt) => (
        ...
        {step === 2 && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <h2 className="text-2xl font-bold mb-6 text-center text-indigo-600">Select Skills</h2>
